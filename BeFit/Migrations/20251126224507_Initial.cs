        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Session_AspNetUsers_TraineeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriesCount = table.Column<uint>(type: "INTEGER", nullable: false),
                    RepsCount = table.Column<uint>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Excercise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Excercise_AspNetUsers_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Excercise_ExcerciseTypeId",
                table: "Excercise",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Excercise_TraineeId",
                table: "Excercise",
                column: "TraineeId");

            migrationBuilder.CreateIndex(
                name: "IX_Session_TraineeId",
                table: "Session",
                column: "TraineeId");
        }
